    ...
    <section>
        <div className="bg-gray-900 w-96 h-screen mx-auto rounded-lg overflow-hidden mt-10">
          ...
          <div className="grid grid-cols-4 gap-2 mt-10 mx-3">
            ...
            <button onClick={handleSlice} className="text-gray w-20 h-20 bg-white rounded-lg font-bold text-3xl flex justify-center items-center shadow">C</button>
            <button value='/' onClick={handleClick} className="text-gray w-20 h-20 bg-white rounded-lg font-bold text-3xl flex justify-center items-center shadow">/</button>
            <button value='+' onClick={handleClick} className="text-gray w-20 h-40 bg-white rounded-lg font-bold text-3xl flex justify-center items-center shadow row-span-2 h-40">+</button>
            ...
            <button value='*' onClick={handleClick} className="text-gray w-20 h-20 bg-white rounded-lg font-bold text-3xl flex justify-center items-center shadow">x</button>
            ...
            <button onClick={handleAnswer} className="text-gray w-42 h-20 bg-white rounded-lg font-bold text-3xl flex justify-center items-center shadow col-span-2">=</button>
...
export default DicodingCalculator;